          ...
          <form class="form-horizontal">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  <a href="evalabort.php"><button type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-remove"> </span> Abort </button></a>
                  <a href="eval2.php"><button type="button" class="btn bg-purple btn-sm"><span class="glyphicon glyphicon-retweet"> </span> Re Evaluasi </button></a>
                  <a href="../p2/p2a.php"><button type="button" class="btn bg-navy btn-sm"><span class="glyphicon glyphicon-retweet"> </span> Re Bid </button></a>
                 
                </div>
                <div class="col-md-6" style="text-align: right;">
                  <a href="browse_evalkom.php"><button type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"> </span> Submit </button></a>
