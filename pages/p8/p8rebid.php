                  ...
                  <div class="box box-danger">
                      <div class="box-body">
                        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                          Untuk melakukan proses re bid, Anda wajib menyertakan Alasan Abort dan Dokumen Pendukung Proses Re Bid pada kolom berikut.    
                        </p>
                        <div class="col-md-12">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="p8iCE.php"><button type="submit" class="btn btn-danger">Yes, Re Bid!</button></a>
                    </div>
                  </div>
                    <!-- /.modal-content -->
                </div>
