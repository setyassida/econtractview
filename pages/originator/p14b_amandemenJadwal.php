...
<body class="hold-transition skin-red fixed sidebar-mini">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-footer ">
                  <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#buttonAmandemen  "> Amandemen Jadwal</button>
                </div>
  ...
  <div id="buttonAmandemen" class="modal">
  		<div class="modal-dialog">
  			<div class="modal-content">
  				<div class="modal-header">
  					</div>
  					<div class="modal-body">
  						<h4 class="modal-title">Apakah anda yakin untuk melakukan <b>Amandenen Jadwal</b> pada kontrak ini?</h4>
  					</div>
