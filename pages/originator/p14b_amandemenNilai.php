            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-4" style="margin-left: 1rem;margin-right: 1rem">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control input-sm" id="pickedByCE2" placeholder="Perubahan nilai kontrak (+/-)" >
                    </div>
                  </div>
                ...
                <div class="box-footer ">
                  <a href="p14b_amandemen.php" class="btn btn-success pull-right btn-sm">Amandemen Kontrak</a>
                </div>
