    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="p1.php">Contract Order</a></li>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body ">
              <table id="example1" class="table table-bordered table-striped table-condensed">
                ...
                <tbody>
                <tr>
                  <td><a href="p6.php">CB-17001</a></td>
                  <td>REGULAR INSPECTION OF LIFTING GEARS</td>
                  <td class="text-center"><span class="label label-primary">Need Your Approval</span></td>
                ...
                <tr>
                  ...
                  <td>Evaluasi Komersial</td>
                  <td>21-Feb-2017</td>
                </tr>
                <tr>
                  <td><a href="p4.php">CA-17003</a></td>
            ...
            <div class="box-footer">
              ...
              <ul>
                <li><span class="label label-primary">Need Your Approval</span> : Contract Order memerlukan persetujuan Anda</li>
