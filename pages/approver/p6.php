              ...
              <table class="table table-bordered table-condensed table-stripped table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="text-center"><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-download-alt"></span> Download</button></div>
                    </td>
                    <td></td>
                    <td></td>
                    <!-- <td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Anda tidak dapat melakukan reject setelah proses ini.
                  </div>
            ...
            <div id="rejectModal" class="modal">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Proses ini akan mengembalikan Evaluasi Teknis ke status draft.
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-sm pull-left" data-dismiss="modal">Tidak</button>
                    <button type="submit" value="submit" class="btn btn-danger btn-sm">Ya</button>
                  </div>
                </div>
                <!-- /.modal-content -->
              </div>
