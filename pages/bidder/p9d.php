  			...
  			<div class="modal-content">
  				<div class="modal-header">
  					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
  						...
  						<h4 class="modal-title">Anda yakin ingin menyanggah LOA ini?</h4>
  					</div>
  					<div class="modal-body">
  						<p>Proses sanggah ini harus dilengkapi dengan :</p>
  						<li>Upload foto bukti transfer jaminan sanggahan</li>
  						<li>Upload dokumen sanggahan</li>
  						<li>Alasan Sanggah</li>
  					</div>
  					<div class="modal-footer">
  						<button type="button" class="btn pull-left" data-dismiss="modal">Cancel</button>
  						<button type="submit" class="btn btn-success">Ya, Saya ingin mengajukan sanggahan</button>
  					</div>
  				</div>
  				<!-- /.modal-content -->
  			</div>
