	...
	<section class="content">
		...
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs">
				...
				<li><a href="#tab_3" data-toggle="tab">Print LOA</a></li>
			</ul>
						...
						<div class="col-md-12">
							...
							<div class="box box-danger">
								<div class="box-header">
									<h3 class="box-title">Lose Bidder</h3>
										...
										<table id="example2" class="table table-bordered table-striped table-condensed">
											...
											<tbody>
												<tr>
													...
													<td>70</td>
													<td>80</td>
													<td>Kurang sesuai dengan deskripsi proyek</td>
												</tr>
												<tr>
													<td>2</td>
													<td>Perusahaan D</td>
							...
							<div class="pull-right" style="margin-right: 2rem">
								<button type="button" class="btn btn-success pull-right btn-sm" data-toggle="modal" data-target="#publishModal">Publish</button>
							</div>
						</div>
					...
					<div class="tab-pane " id="tab_2">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="text-muted well well-sm ">
									<h4 class="center text-center">LOA <b>belum</b> di PUBLISH, tidak ada proses sanggah sebelum LOA di publish.</h4>
								</div>
						...
						<div class="tab-pane " id="tab_3">
							<div class="row">
								<div class="col-md-12">
									<div class="text-muted well well-sm ">
										<h4 class="center text-center">Print LOA</h4>
									</div>
									<div class="text-center">
										<button type="button" class="btn btn-lg" data-toggle="modal" data-target="#printModal">Print</button>
									</div>
