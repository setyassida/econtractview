  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <li class="active"><a href="p15cpublished.php">BL-17005</a></li>
      </ol>
      </section>
          ...
          <div class="col-md-8">
            <div class="box box-info">
              <div class="box-header">
                ...
                <div class="mark pull-right"><strong>Status: </strong>PUBLISHED</div>
              </div>
              <div class="box-body">
                <div class="row">
                  <div class="col-md-4">
              ...
              <div class="box-footer">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="pull-right" style="margin-left: 1rem">
                      <a href="p15-invitation.php"><button class="btn btn-primary pull-right btn-sm">Resend</button></a>
                    </div>
                  </div>
                </div>
