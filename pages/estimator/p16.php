        ...
        <div class="box-body">
          <table id="dataTable" class="table table-bordered table-condensed table-hover">
            ...
            <tr>
              ...
              <td><div class="text-center"><span class="label label-primary">To be approved</span></div></td>
              <td><div class="text-center"><a href="p16-view.php"><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-eye-open"></span> Lihat HPS</button></a></div></td>
              <td><div class="text-center"><button type="button" class="btn btn-default btn-xs" disabled><span class="glyphicon glyphicon-cloud-upload" disabled></span> Upload</button></div></td>
              <td><button type="button" class="btn btn-default btn-xs" disabled><span class="glyphicon glyphicon-download-alt"></span> Download</button></td>
            ...
            <tr>
              <td><a href="p16-view.php">0005/HPS/2017</a></td>
              <td>28-01-2018</td>
              <td>CB-18001</td>
