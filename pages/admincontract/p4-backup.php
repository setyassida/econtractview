        ...
        <div class="box-body">
          <table id="dataTable" class="table table-bordered table-condensed table-hover">
            ...
            <tr>
              ...
              <th style="width:50px">Lihat HPS <span class="text-red"></span></th>
            ...
            <tr>
              ...
              <td><div class="text-center"><a href="p4-view.php"><button type="button" class="btn btn-default btn-xs" disabled><span class="glyphicon glyphicon-eye-open"></span> Lihat HPS</button></a></div></td>
              <td><button type="button" class="btn btn-default btn-xs" disabled><span class="glyphicon glyphicon-download-alt"></span> Download</button></td>
