...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Reporting
        <small>Laporan CSMS dan Tenaga Kerja</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      ">
          ...
          <div class="box-header with-border">
            <h4>Laporan CSMS dan Tenaga Kerja</h4>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <div class="col-md-12">
              <form class="form-horizontal">
                <div class="form-group"> 
                  ...
                  <a href="p20.php"><button type="button" class="btn btn-success btn-sm">Create</button></a>
                 </div>
              </form>
            </div>
