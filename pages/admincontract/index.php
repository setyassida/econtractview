            ...
            <div class="box box-default">
              ...
              <div class="box-body">
                <div class="alert alert-info alert-dismissible">
                  ...
                  <i class="icon fa fa-check"></i> You Have New CO
                </div>
                <div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <i class="icon fa fa-check"></i> CO Need Approval
                </div>
                <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                  <i class="icon fa fa-check"></i> CB-17002 Aborted
                </div>
                <table class="table table-condensed input-sm table-striped table-bordered">
                  ...
                  <tbody>
                    <tr>
                      <th>CO Need Prebid Meeting</th>
                      <td class="text-center">2</td>
                    </tr>
                    <tr>
                      <th>CO Need Closing/Opening</th>
                    ...
                    <tr>
                      <th>CO Need Kick Off Meeting</th>
                      <td class="text-center">1</td>
                    </tr> 
                    <tr>
                      <th>Letter of Intention</th>
              ...
              <div class="box box-default">
                ...
                <div class="box-body">
                  <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <i class="icon fa fa-check"></i> Contract Agreement Completed
                  </div>                  
                </div>
                <!-- /.box-body -->
              </div>            
            ...
            <div class="col-md-12">
              <div class="box box-default">
                ...
                <div class="box-body">
                  <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <i class="icon fa fa-check"></i> Amandement Completed
                  </div>
                  <table class="table table-condensed input-sm table-striped table-bordered">
                    <thead class="bg-primary">
                      <tr>
