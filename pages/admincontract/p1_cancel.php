  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="p2a.php">Cancel</a></li>
      </ol>
    </section>
          ...
          <form class="form-horizontal">
            ...
            <div class="box box-warning">
                    ...
                    <div class="box box-warning">
                      <div class="box-body">
                        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                          Untuk melakukan proses Cancel, Anda wajib menyertakan Alasan Cancel dan Dokumen Pendukung Proses Cancel pada kolom berikut.
                        </p>
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                            <label>Dokumen Pendukung Proses Cancel:</label>
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-warning pull-right btn-sm" style="margin-right: 5px;" data-toggle="modal" data-target="#RejectModal">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-warning">Yes, Cancel Now!</button>
                      </div>
                    </div>
                      <!-- /.modal-content -->
                  </div>
