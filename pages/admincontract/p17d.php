                        ...
                        <div class="box-body">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                                  ...
                                  <div class="box-body">
                                    ...
                                    <div class="col-md-12" style="text-align: left;">
                                      <a href="p17.php"><button type="button" class="btn btn-success btn-sm" title="Kembali Rincian"><span class="fa fa-plus"></span> Tambah Rincian</button></a>
                                    </div>
                                    <br>
                                    <br>
                                    <br>
                           ...
                           <div class="col-md-12 box-footer" style="text-align: right;">
                                    ...
                                    <a href="p17.php"><button type="button" class="btn btn-success btn-sm" title="Kembali Rincian">Simpan</button></a>
                            </div>
                        </div>
                      </form>
                    </div>
