    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="p2a.php">View Evaluasi Semester</a></li>
          ...
          <div class="tab-content">
              ...
              <form class="form-horizontal">
                <div class="box-body">
                  <div class="well well-sm text-center">
                    <h4>Hasil evaluasi <b>Jasa Pemborongan</b> Keseluruhan : <br><b>90.00</b> <br> <b> SANGAT BAIK</b></h4> <br>
                  </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                  ...
                  <div class="col-md-10">
                    Keterangan hasil penilaian adalah sebagai berikut: <br>
                    <div class="col-md-2"><span class="label label-default">80.56 - 100.00</span></div> <div class="col-md-10" style="margin-left:-5rem">: Sangat Baik (Mampu)</div>
                    <div class="col-md-2"><span class="label label-default">60.56 - 80.55</span></div> <div class="col-md-10" style="margin-left:-5rem">: Baik (Mampu)</div>
                    <div class="col-md-2"><span class="label label-default">49.56 - 60.55</span></div> <div class="col-md-10" style="margin-left:-5rem">: Cukup (Mampu)</div>
                    <div class="col-md-2"><span class="label label-default">0 - 49.55</span></div> <div class="col-md-10" style="margin-left:-5rem">: Kurang (Tidak Mampu)</div>
                  </div>
                  <div class="col-md-2">
                    <button type="button" class="btn btn-sm btn-success pull-right "><span class="glyphicon glyphicon-floppy-disk"></span>Download </button>
                  </div>
            ...
            <div class="tab-pane" id="tab_2">
              ...
              <div class="box-footer">
                <div class="col-md-12">
                  <div class="well well-sm text-center">
                    <h4>Hasil evaluasi <b>Jasa Tenaga Kerja</b> Keseluruhan : <br><b>90.00</b> <br> <b> SANGAT BAIK</b></h4> <br>
                  </div>
                ...
                <div class="col-md-2">
                  <button type="button" class="btn btn-success pull-right "><span class="glyphicon glyphicon-floppy-disk"></span>Download </button>
                </div>
