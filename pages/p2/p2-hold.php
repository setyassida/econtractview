          ...
          <form class="form-horizontal">
            ...
            <div class="box box-warning">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-warning pull-right" style="margin-right: 5px;" data-toggle="modal" data-target="#abortModal">
                <span class="glyphicon glyphicon-remove"></span> Hold
                </button>
