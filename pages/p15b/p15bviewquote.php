  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="p15bviewquote.php">Detail VO</a></li>
      </ol>
    </section>
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="text-center">
              <h3 class="box-title">STATUS : <span class="mark text-success">QUOTE</span></h3>
            </div>
            <!-- tab1 -->
            ...
            <div class="row" style="padding-bottom: 0.5rem">
              ...
              <div class="col-md-6 text-right">
                <a href="p15bquote.php" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Modify Penawaran VO</a>
              </div>
            </div>
          </div>
          <!-- ./tabs content -->
