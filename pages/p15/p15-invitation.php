  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="p15cdraft.php">BL-17001</a></li>
        <li class="active"><a href="p15-invitation.php">Send Invitation Note</a></li>
      </ol>
    </section>
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="form-group" style="margin-bottom: 0.5rem">
                            ...
                            <div class="input-group date">
                              <input type="text" class="form-control pull-right input-sm" id="datepicker1" placeholder="Tanggal Pelaksanaan Prebid Meeting" required>
                          ...
                          <div class="row">
                            <div class="col-md-6" style="margin-bottom: 0.5rem">
                              <div class="form-group">
                                <div class="input-group date">
                                  <input type="text" class="form-control input-sm" id="datepicker2" placeholder="Bid Closing/Opening Date" required>
                                  <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                  </div>
                                </div>
                            ...
                            <div class="col-md-6" style="margin-bottom: 0.5rem">
                              <div class="form-group bootstrap-timepicker">
                                <div class="input-group">
                                  <input type="text" class="form-control timepicker input-sm" required>
                                  <div class="input-group-addon">
                          ...
                          <div class="row">
                            <div class="col-md-6" style="margin-bottom: 0.5rem">
                              <div class="form-group">
                                <div class="input-group date">
                                  <input type="text" class="form-control input-sm" id="datepicker3" placeholder="Closing/Opening Teknis Date" required>
                                  <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                  </div>
                                </div>
                          ...
                          <div class="form-group" style="margin-bottom: 0.5rem">
                            ...
                            <input type="text" class="form-control input-sm" id="generatedBySystem2" placeholder="Lokasi" required>
                          </div>
