    ...
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-footer">
           ...
           <a href="p17CE.php"><button type="button" class="btn btn-success btn-sm" data-toggle="hold" title="Kembali ke menu browse"><span class="glyphicon glyphicon-ok-circle"></span> Finish</button></a>
        </div>
