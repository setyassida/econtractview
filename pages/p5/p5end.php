              ...
              <div class="box-body"> 
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="control-label col-md-2" ">Hasil Form :</label>
                    <div class="col-md-9">
                  ...
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label class="control-label col-md-2" ">Upload Form yang sudah ditandatangani :</label>
                  ...
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label class="control-label col-md-2" ">Hasil HPS :</label>
                    <div class="col-md-9">
                      <p class="form-control-static">Pengadaan Sistem Informasi Kepegawaian</p>
                    </div>
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label class="control-label col-md-2" ">Upload HPS yang sudah ditandatangani :</label>
                    <div class="col-md-9" style="padding-top: 1rem">
                      <input type="file" id="" accept=".pdf">
                    </div>
                  </div>
