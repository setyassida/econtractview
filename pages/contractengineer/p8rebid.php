  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <!-- SELECT2 EXAMPLE -->
        <div class="box" style="border-top-color: #001F3F;">
          <form class="form-horizontal">
                  ...
                  <div class="box" style="border-top-color: #001F3F;">
                      <div class="box-body">
                        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                          Untuk melakukan proses re bid, Anda wajib menyertakan Alasan Re Bid dan Dokumen Pendukung Proses Re Bid pada kolom berikut.    
                        </p>
                        <div class="col-md-12">

                          <div class="form-group">
                            <label>Alasan Re Bid :</label>
                            <textarea class="form-control" rows="5" placeholder="Enter ..." style="resize:none" required></textarea>
                          </div>
                          <div class="form-group">
                            <label>Dokumen Pendukung Proses Re bid:</label>
            ...
            <div class="box-footer">
              ...
              <button type="button" class="btn bg-navy pull-right" style="margin-right: 5px;" data-toggle="modal" data-target="#rebidModal">
              <span class="glyphicon glyphicon-remove"></span> Re Bid
              </button>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Are You Sure to Re Bid It?</h4>
                    </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="p8iCE.php"><button type="submit" class="btn bg-navy btn-sm">Yes, Re Bid!</button></a>
                    </div>
                  </div>
                    <!-- /.modal-content -->
                </div>
