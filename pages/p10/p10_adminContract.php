...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Menu Admin Contract</li>
    </ol>
  </section>
  ...
  <section class="content">
    <div class="box collapsed-box">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="col-md-12">
            <h3>Unduh dan Unggah Form Kelengkapan</h3>
            <table class="table table-hover input-sm">
              <tr>
                <th>Nama Form</th>
                <th>Unduh Template Form</th>
                <th class="text-center">Upload Form</th>
              </tr>
              <tr>
                <td>Pembuatan Badge</td>
              ...
              <tr>
                <td>Pembuatan Safety Passport</td>
                <td><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-download-alt"></span> Download</button></td>
                <th><div class="text-center"><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-cloud-upload"></span> Upload</button></div></th>
              </tr>
            </table>
          ...
          <div class="col-md-12">
            ...
            <table class="table table-hover input-sm">
              ...
              <tr>
                <td>Polis Asuransi Contractor All Risk</td>
                <th><div class="text-center"><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-cloud-upload"></span> Upload</button></div></th>
              </tr>
              <tr>
                <td>Polis Asuransi Third Party Liability (ATPL)</td>
                <th><div class="text-center"><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-cloud-upload"></span> Upload</button></div></th>
              </tr>
              <tr>
              ...
              <tr>
                <td>Surat Pernyataan Keaslian Performance Bond</td>
                <th><div class="text-center"><button type="button" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-cloud-upload"></span> Upload</button></div></th>
              </tr>
              <tr>
        ...
        <div class="box-footer">
          <div class="pull-right" style="margin-right: 2rem">
  								<button type="button" class="btn btn-success pull-right btn-sm" data-toggle="modal" data-target="#publishModal">Submit Drift Kick Off Meeting</button>
  							</div>
        </div>
      </div>
      <!-- /.box -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <h4 class="modal-title">Apakah anda yakin untuk men submit Draft Kick Off Meeting ini?</h4>
        </div>
