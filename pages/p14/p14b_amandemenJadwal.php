        ...
        <div style="margin-bottom:20px; margin-top:10px;" class="col-md-4 input-sm pull-right">
          <div class="form-group">
            <select class="form-control">
              ...
              <option selected="true">Amandemen Jadwal</option>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-footer ">
                  <button type="button" class="btn btn-success pull-right btn-sm" style="margin-right: 5px;" data-toggle="modal" data-target="#amandemenModal"> Amandemen Jadwal Kontrak</button>
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Proses ini akan melakukan amandemen kontrak pada bagian <b>Jadwal Kontrak</b>, <b>Jadwal Kontrak akan diperbarui.</b></p>
        </div>
