  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="p3pviewawaitquote.php">Detail</a></li>
      </ol>
    </section>
          ...
          <div class="tab-content">
            ...
            <div class="row" style="padding-bottom: 0.5rem">
              <div class="col-md-12 text-right">
                <a href="p3pnotquote.php" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Not Quote</a>
                <a href="p3pquote.php" class="btn btn-sm btn-success"><i class="fa fa-check"></i> Quote</a>
