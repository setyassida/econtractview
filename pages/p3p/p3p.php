  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="p3p.php">Penawaran</a></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped table-condensed table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center"><a href="p3pviewawaitquote.php"><button class="btn btn-xs btn-default">Lihat Detail</button></a></td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-center"><a href="p3pviewquote.php"><button class="btn btn-xs btn-default">Lihat Detail</button></a></td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-center"><a href="p3pviewnotquote.php"><button class="btn btn-xs btn-default">Lihat Detail</button></a></td>
                  </tr>
